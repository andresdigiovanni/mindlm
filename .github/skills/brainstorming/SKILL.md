...
4. Present design sections → user approves → revise if needed
5. Write design doc → spec self-review (fix inline) → user reviews spec
6. Invoke writing-plans skill

**The terminal state is invoking writing-plans.** Do NOT invoke any other implementation skill after brainstorming.
